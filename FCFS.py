...
def fcfs(list_pro_fcfs, num_pro):
    ...
    t = 0 # t is the index of first place of list_process that a process should be put in ready queue
    list_final_process = []
    ready_queue = []
    current_and_t = []
    while(done != num_pro):
        done_or_not = do_process(list_final_process, list_pro_fcfs, current_time, ready_queue, t, current_and_t)
